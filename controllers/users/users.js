...
const addNewUser = async (req, res, next) => {
    try {
        ...
        const user = new UserModel({ email: email, password: hashPassword, avatarURL: avatarRandom, verificationToken: verificationToken, });
        await user.save();
        const massageVerify = {
            to: email,
...
const dubleVerifyUser = async (req, res, next) => {
    try {
...
module.exports = { getCurentUser, userLogin, addNewUser, updateSubscription, updateAvatar, logOutUser, verifyUser, dubleVerifyUser };
